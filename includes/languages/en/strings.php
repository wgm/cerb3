...
define("LANG_AUDIT_ACTION_REMOVE_REQUESTER","<b>%s</b> removed <b>%s</b> from the ticket requesters.");
...
define("LANG_AUDIT_ACTION_CHANGED_STATUS_ID","<b>%s</b> changed custom status id to <b>%s</b>.");
...
define("LANG_AUDIT_ACTION_RULE_CUSTOMER_WAITING","<b>Parser</b> mail rule set Waiting On Customer Reply to <b>%s</b>.");
...
define("LANG_AUDIT_ACTION_TICKET_SPLIT_FROM","<b>%s</b> split ticket from #%s.");
define("LANG_AUDIT_ACTION_TICKET_SPLIT_TO","<b>%s</b> split ticket to #%s.");
...
define("LANG_DISPLAY_THREAD_TOGGLE_HIDDEN","toggle hidden threads");
define("LANG_DISPLAY_THREAD_TOGGLE_TIME","toggle time tracking threads");
define("LANG_DISPLAY_THREAD_TOGGLE_QUOTED","toggle quoted text");
...
define("LANG_PREF_AUTO_SIG_QUOTE_PREVIOUS", "Quote Previous Message in Reply / Forward:");
...
define("LANG_THREAD_UNHIDE", "Unhide");
...
define("LANG_WORD_STATUS","Ticket State");
define("LANG_WORD_NEW_STATUS","Ticket Status");
