...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 3.6 Database Verification Script");
...
function init_table_log()
{
	...
	$TABLE_DEF->fields["log_date"] = new CER_DB_FIELD("log_date","timestamp(14)","YES","","","on update current_timestamp");
