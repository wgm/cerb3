...
<br>
	<form action="" method="post">
		...
		<table border="0" cellpadding="5" cellspacing="0">
			<tr>
				<td>
					<span class="cer_maintable_heading">Status:</span><br>
					<select name="status" class="cer_footer_text">
						<option>All</option>
				...
				<td>
					<span class="cer_maintable_heading">Tags:</span><br>
					<input type="text" name="tags" value="" class="cer_footer_text">
				</td>
