 ...
 *
 */
class unflag_tickets_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return unflag_tickets_handler
    */
   function unflag_tickets_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($email_obj->unflag_tickets($tickets, $agent_id) === FALSE) {
         xml_output::error(0, 'Unflag tickets failed'); 
      }
      else {
         xml_output::success();
      }
