 ...
 *
 */
class report_spam_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return report_spam_handler
    */
   function report_spam_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($email_obj->report_spam_tickets($tickets, $agent_id) === FALSE) {
         xml_output::error(0, 'Report spam failed'); 
      }
      else {
         xml_output::success();
      }
