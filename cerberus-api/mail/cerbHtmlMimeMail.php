...
*/
	...
	$cfg = CerConfiguration::getInstance();
        ...
        */
		...
		$this->smtp_params['auth'] = (!empty($cfg->settings["smtp_server_user"])) ? TRUE : FALSE;
		$this->smtp_params['user'] = (!empty($cfg->settings["smtp_server_user"])) ? $cfg->settings["smtp_server_user"] : '';
		$this->smtp_params['pass'] = (!empty($cfg->settings["smtp_server_pass"])) ? $cfg->settings["smtp_server_pass"] : '';
